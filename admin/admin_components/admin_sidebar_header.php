          ...
          <div class="flex items-center ml-3">
            ...
            <div class="z-50 hidden my-4 text-base list-none divide-y divide-gray-100 rounded shadow bg-gray-700 divide-gray-600" id="dropdown-user">
              ...
              <ul class="py-1" role="none">
                ...
                <li>
                  <a href="./auth/logout.php" class="block px-4 py-2 text-sm text-gray-50    dark:hover:text-white" role="menuitem">Sign out</a>
                </li>
              </ul>
            </div>
          </div>
...
<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r border-gray-200 sm:translate-x-0 bg-teal-900 " aria-label="Sidebar">
   <div class="h-full px-3 pb-4 overflow-y-auto bg-teal-900">
      <ul class="space-y-2">
         <li>
            <a href="./admin_home.php" class="flex items-center p-2 text-base font-normal text-gray-50 rounded-lg text-white hover:bg-gray-800 bg-teal-900">
         ...
         <li>
            <a href="./admin_category.php" class="flex items-center p-2 text-base font-normal text-gray-50 rounded-lg text-white hover:bg-gray-800 bg-teal-900">
         ...
         <li>
            <a href="./manage_products.php" class="flex items-center p-2 text-base font-normal text-gray-50 rounded-lg text-white hover:bg-gray-800 bg-teal-900">
         ...
         <li>
            <a href="./user_list.php" class="flex items-center p-2 text-base font-normal text-gray-50 rounded-lg text-white hover:bg-gray-800 bg-teal-900">
               <svg aria-hidden="true" class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 text-gray-400 group-hover:text-gray-50 dark:group-hover:text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z" clip-rule="evenodd"></path></svg>
               <span class="flex-1 ml-3 whitespace-nowrap">Manage Users</span>
            </a>
         </li>
         <li>
            <a href="./admin_cart.php" class="flex items-center p-2 text-base font-normal text-gray-50 rounded-lg text-white hover:bg-gray-800 bg-teal-900">
         ...
         <li>
            ...
            <ul id="dropdown-example" class="hidden py-2 space-y-2">
                  <li>
                     <a href="./manage_utilities.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-teal-800 dark:text-white ">Add Locations / Village</a>
                  </li>
                  <li>
                     <a href="./manage_utilities.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-teal-800 dark:text-white ">Add City</a>
                  </li>
                  <li>
                     <a href="./manage_utilities.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-teal-800 dark:text-white ">Add Pincode</a>
                  </li>
                  <li>
                     <a href="./manage_utilities.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-teal-800 dark:text-white ">Add District</a>
                  </li>
                  <li>
                     <a href="./manage_utilities.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-teal-800 dark:text-white ">Add Tehsil</a>
                  </li>
                  <li>
                     <a href="./manage_utilities.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-teal-800 dark:text-white ">Add State</a>
                  </li>
                  <li>
                     <a href="./manage_colors.php" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-teal-800 dark:text-white ">Manage colors</a>
                  </li>
            </ul>
         </li>
