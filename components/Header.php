...
<nav class="bg-teal-800">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
        <a href="../../Online_Grocery/index.php" class="flex items-center">
        ...
        <div class="flex items-center">
            ...
            <!-- <a href='../../Online_Grocery/auth/login.php' class="text-sm font-medium text-white hover:underline">Login  </a>
            <a href="../../Online_Grocery/auth/logout.php" class="text-sm font-medium text-white hover:underline">Logout  </a> -->
            <!-- //$message!="" -->
          <?php
             ...
             if(!isset($_SESSION['id']) ) {
              ...
              echo'<a href="../../Online_Grocery/auth/login.php" class="text-sm font-medium text-white hover:underline">Login  </a>';
             ...
             $data=mysqli_fetch_assoc($result);
                  echo'<a href="../../Online_Grocery/users_cart.php" role="button" class="relative flex">
                ...
                echo'<a href="../../Online_Grocery/auth/logout.php" class="text-sm font-medium text-white hover:underline mx-2">Logout  </a>';
              }
...
<nav class="header sticky z-10 top-0 bg-white shadow-md flex items-center justify-between px-2 py-1">
  ...
  <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
    ...
    <li class="px-1 hover:border-b-2 hover:border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-800 font-roboto font-bold duration-200 cursor-pointer active">
              <a href="../../Online_Grocery/index.php">Home</a>
            </li>
            <li class="px-1 hover:border-b-2 hover:border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-800 font-roboto font-bold duration-200 cursor-pointer">
              <a href="../../Online_Grocery/index.php">Products</a>
            </li>
            <li class="px-1 hover:border-b-2 hover:border-green-500 border-opacity-0 hover:border-opacity-100 hover:text-green-800 font-roboto font-bold duration-200 cursor-pointer">
              <a href="">Contact Us</a>
            </li>
